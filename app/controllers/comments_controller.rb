class CommentsController < ApplicationController
  ...
  def current_user_must_be_comment_user
    ...
    unless current_user == comment.user_with_makes_comments
  ...
  def index
    ...
    @comments = @q.result(:distinct => true).includes(:user_with_makes_comments, :photo_with_comments).page(params[:page]).per(10)
